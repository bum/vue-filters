...
// EXTERNAL MODULE: ./src/filters/util/index.js + 9 modules
...
var filters = _objectSpread({}, _string__WEBPACK_IMPORTED_MODULE_11__, {}, _array__WEBPACK_IMPORTED_MODULE_12__); // Declare install function executed by Vue.use()
...
function install(Vue) {
  ...
  var names = !options.filters ? Object.keys(filters) : Object(_util__WEBPACK_IMPORTED_MODULE_13__[/* isArray */ "d"])(options.filters) ? options.filters : Object(_util__WEBPACK_IMPORTED_MODULE_13__[/* isString */ "j"])(options.filters) ? options.filters.trim().split(' ') : Object.keys(filters);
  names.forEach(function (name) {
    return filters[name] && Vue.filter(name, filters[name]);
  });
...
/* concated harmony reexport install */__webpack_require__.d(__webpack_exports__, "install", function() { return filters["b" /* install */]; });
